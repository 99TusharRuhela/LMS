							   ...
							   <table class="table table-bordered">
							    <tr>
							    	<td><select name="enr" class="form-control">
											...
											<?php
											 $res=mysqli_query($conn,"select student_enrollment from issue_books where books_return_date=''");
							        ...
							        <td>
									 <input type="submit" value="Search" name="submit1" class="form-control" style="background-color:blue; color:white;"/>
									</td> 
								</tr>
