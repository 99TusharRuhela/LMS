...
<div class="col-lg-12 text-center ">
    <h1 id="ha" style="font-family:Lucida Console">Library Management System</h1>
</div>
    ...
    <section class="login_content">
        <form name="form1" action="" method="post">
	     ...
	     if(isset($_POST['submit1']))
		  {
			$count=0;
			$res = mysqli_query($conn,"select * from librarian_registration where username='$_POST[username]' && password='$_POST[password]'");
