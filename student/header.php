...
$tot=0;
$res=mysqli_query($conn,"select * from messages where dusername='$_SESSION[username]' && read1='n'");
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="message_from_librarian.php"><i class="fa fa-envelope-o"></i> Message From Librarian <span
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li role="presentation" class="dropdown">
                            <a href="message_from_librarian.php" class="dropdown-toggle info-number" data-toggle="dropdown"
                               aria-expanded="false">
       <!-- /Message -->          <i class="fa fa-bell-o"></i>
