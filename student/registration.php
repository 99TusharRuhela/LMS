...
<body class="login" style="margin-top: -20px;">
    ...
    <div class="login_wrapper">
		...
		<?php
		  ...
		  {
		      mysqli_query($conn,"insert into student_registration values('','$_POST[firstname]','$_POST[lastname]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[contact]','$_POST[sem]','$_POST[enrollmentno]','no')");
		?>
